...
- Accessing Whole Slide Images (WSIs), example python script for loading WSIs in SVS,MRXX and DCOM format : https://github.com/solmazhaddady/NMSC-TCIA-Dataset/blob/main/src/load_wsi.py
